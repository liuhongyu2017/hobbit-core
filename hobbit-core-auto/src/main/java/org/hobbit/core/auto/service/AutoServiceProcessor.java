...
import org.hobbit.core.auto.common.AbstractHobbitProcessor;
import org.hobbit.core.auto.common.MultiSetMap;
import org.hobbit.core.auto.common.Sets;
import org.hobbit.core.auto.common.TypeHelper;
...
public class AutoServiceProcessor extends AbstractHobbitProcessor {
  ...
  public AnnotationValue getAnnotationValue(AnnotationMirror annotationMirror, String elementName) {
    ...
    for (Map.Entry<ExecutableElement, AnnotationValue> entry : getAnnotationValuesWithDefaults(
    ...
    throw new IllegalArgumentException(
        String.format("@%s does not define an element %s()", name, elementName));
  }
   ...
   * @return AnnotationValue Map
   */
  public Map<ExecutableElement, AnnotationValue> getAnnotationValuesWithDefaults(
    ...
    for (ExecutableElement method : ElementFilter.methodsIn(
      ...
      if (declaredValues.containsKey(method)) {
        ...
        throw new IllegalStateException(
            "Unset annotation value without default should never happen: " + name + '.'

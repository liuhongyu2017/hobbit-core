 ...
 */
public interface HobbitRedisSerializerConfigAble {
   ...
   *
   * @param properties 配置
   * @return RedisSHobbitzer
   */
  RedisSerializer<Object> redisSerializer(HobbitRedisProperties properties);
   ...
   */
  default RedisSerializer<Object> defaultRedisSerializer(HobbitRedisProperties properties) {
    HobbitRedisProperties.SerializerType serializerType = properties.getSerializerType();
    if (HobbitRedisProperties.SerializerType.JDK == serializerType) {
      /*

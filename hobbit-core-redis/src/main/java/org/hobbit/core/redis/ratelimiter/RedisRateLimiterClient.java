package org.hobbit.core.redis.ratelimiter;
...
public class RedisRateLimiterClient implements IRateLimiterClient {
  ...
  public boolean isAllowed(String key, long max, long ttl, TimeUnit timeUnit) {
    // redis key
    String redisKeyBuilder =
        REDIS_KEY_PREFIX + getApplicationName(environment) + CharPool.COLON + key;

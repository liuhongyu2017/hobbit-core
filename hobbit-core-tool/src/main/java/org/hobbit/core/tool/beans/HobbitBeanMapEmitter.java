 ...
 * @author L.cm
 */
class HobbitBeanMapEmitter extends ClassEmitter {

  private static final Type BEAN_MAP = TypeUtils.parseType(HobbitBeanMap.class.getName());
  private static final Type FIXED_KEY_SET = TypeUtils.parseType(

package org.hobbit.core.cache.utils;
...
public class CacheUtil {
  ...
  public static String formatCacheName(String cacheName, String tenantId) {
    return (StringUtil.isBlank(tenantId) ? cacheName
  ...
  public static Object get(String cacheName, String keyPrefix, Object key, Boolean tenantMode) {
    ...
    Cache.ValueWrapper valueWrapper = getCache(cacheName, tenantMode).get(
        keyPrefix.concat(String.valueOf(key)));
